package com.yenaing.apps.tasks.data.repository

import android.net.Uri
import android.util.Log
import com.yenaing.apps.tasks.TaskApp
import com.yenaing.apps.tasks.data.db.TaskDatabase
import com.yenaing.apps.tasks.data.model.SubTask
import com.yenaing.apps.tasks.data.model.Task
import com.yenaing.apps.tasks.util.AppConstants.BACKUP
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.COLOR
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.COMPLETED
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.CSV_SUBTASK_FILE_NAME
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.CSV_TASK_FILE_NAME
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.DATE_TIME
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.END_DATE
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.ID
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.IMP
import com.yenaing.apps.tasks.util.AppConstants.DEFAULT_LINE_END
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.PROGRESS
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.REMINDER
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.SID
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.START_DATE
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.SUBTASKS
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.TASK_DIR
import com.yenaing.apps.tasks.util.AppConstants.BackUpRepo.TITLE
import com.yenaing.apps.tasks.util.AppConstants.RESTORE
import com.yenaing.apps.tasks.util.CsvUtil
